    ...
    <section className="bg-indigo-50 dark:bg-gray-700">
     ...
     <section className="bg-blue-50 dark:bg-gray-800">
        <div className="container m-auto max-w">
          <div className="bg-white  dark:bg-gray-800 py-8 shadow-md rounded-md   md:m-0">
            <main>
                <div className="bg-white w-full overflow-hidden dark:bg-gray-800 dark:border-1 dark:border-indigo-500  rounded-lg shadow-md text-center ">
                <img src={`/public/img/${article.img}`} alt={article.title} className='w-full object-cover'/>
                <div>
                <h1 className="text-6xl  text-blue-200 font-tangerine font-bold mb-4">{article.title}</h1>
              ...
              <h2 className="text-blue-500  text-lg font-bold mb-3">{!article.subtitle? "":article.subtitle}</h2>
